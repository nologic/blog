...
This takes up 24 bytes of the message. Next is the header for [__CFMessagePortMachMessage](https://github.com/opensource-apple/CF/blob/master/CFMessagePort.c) which comes with a nice magic four byte marker - 0xF0F2F4F8 - to help us identify the message.
